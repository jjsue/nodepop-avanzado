...
module.exports = function () {
    return (req, res, next) => {
        //Primero tomamos el token.
        const token = req.headers.auth //En este caso vamos a pedir que nos devuelvan la string del token en las cabeceras bajo el nombre de "auth"
        if (token === undefined) {
            ...
            //Verificamos que el código sea valido.
